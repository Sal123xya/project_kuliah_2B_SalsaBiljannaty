    ...
    if ($statusUpload == 0) {
        ...
        if (mysqli_num_rows($select) > 0) {
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "UPDATE tb_daftar_product SET foto='" . $kode_rand . $_FILES['foto']['name'] . "', nama_product='$nama_product', keterangan='$keterangan', kategori='$kat_product', harga='$harga', stok='$stok' WHERE id='$id'");
